...
SECRET_KEY = '7#g%#6e-+e%*eb%d3ktvog_thwcz82%l8^@noi$))i(mb0ht*o'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['pyleks-boutique-ado.herokuapp.com', 'localhost']
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',  # used for simplify tracking our users
...
ACCOUNT_AUTHENTICATION_METHOD = 'username_email'  # We can choose eto either use email or username
...
# Stripe
# TODO Need to figure out the env variables
# TODO Revisit webhook
